...
Download the grayscale.zip file from moodle and unzip it in the programms/-directory of your
virtual prototype. This zip-file contains all the source file required to grab an image from the camera,
convert it to grayscale, and show it on the HDMI-screen/grabber.
Compile the program and run it on your virtual prototypes/gecko5_or1420.lpf: This file contains the pin-mapping of the top level to the FPGA-pins. 
